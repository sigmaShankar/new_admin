    ...
    <>
      ...
      <AppBar position="fixed" className={classes.appBar}>
        <Toolbar className={classes.toolbar}>
          ...
          <div >
            <img style={{ height: "6rem", width: "13rem", marginLeft: "-13px", position: "absolute", marginTop: "-3rem", float: "left" }} src={require("../../assets/Sigma-red-Final-logo.png")} />
          </div>
          <span style={{ marginLeft: "180px", borderLeft: "2px solid #23284a",minHeight:"5px" }}>
            <h6 style={{ color: "black", float: "right", marginLeft: "10px",marginTop: "2%" }}>COLORADO SENATE BILL 21-169</h6>
          </span>
