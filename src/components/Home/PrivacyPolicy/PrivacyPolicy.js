...
const PrivacyPolicy = (props) => {
  ...
  return (
    <div style={{marginTop: "7rem"}}>
        <CommonHeader 
            headerPolicy="Privacy Policy"
            img="assets/privacy-policy.jpg" />
    <div className={styles["content"]}>
<p style={{marginTop: "1rem"}}>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
<p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p>
<h1>DISCLAIMER</h1>
<p>Whilst Campusfield - Kochi takes care to guarantee the exactness of the content, to the degree allowed by law, Campusfield assumes no lawful risk for and does not warrant that data contained on this website is precise or complete, or these webpages will be free from mistakes or that its accessibility will be continuous and Campusfield thus explicitly disowns and avoids all express and inferred guarantees terms or conditions not expressed in this, so far as such rejection or disclaimer is allowed under the appropriate law. Campusfield bars all risk to any individual for any misfortune or harm brought about by any mistakes or exclusions, regardless of whether such inaccuracies or oversights results from neglect, mishap or some other reason, yet this disclaimer is without bias to any cases for fake deception , individual wounds or passing.</p>
...
<ul>
    ...
    <li>
    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Campusfield, 10/870, Thengode, Kakkanad, Kochi, India 682030.</p>
    </li>
    <li>
    ...
    <li>
    <p><strong>Website</strong> refers to Campusfield, accessible from <a href="https://www.campusfield.in/" rel="external nofollow noopener" target="_blank">https://www.campusfield.in/</a></p>
    </li>
    <li>
...
<ul>
    <li>
    <p>By email: campusfield@gmail.com</p>
    </li>
    <li>
    <p>By visiting this page on our website: <a href="https://www.campusfield.in/contact-us" rel="external nofollow noopener" target="_blank">https://www.campusfield.in/contact-us</a></p>
    </li>
</ul>   
            </div>
    </div>
