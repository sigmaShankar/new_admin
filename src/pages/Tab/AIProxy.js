...
import Evaluate_ from "./Ethics/Evaluate";

import MetricsBar from "./Ethics/MetricsBar";
import Donut from "./Ethics/Donut";
// components
    ...
    <>
      ...
      <div >
        <Grid container spacing={6}>
            {
              customValue && Object.keys(customValue).length && customValue[currentAlgo] && Object.keys(customValue[currentAlgo]).map(metric => <MetricsGraph name={metric}  algo={currentAlgo} data={customValue[currentAlgo][metric]} dates={dateList} />)
            }
        </Grid>
      </div>
